		...
		protected var uiXML:XML =
			<View>
			  <Container x="-2" y="-42">
			    ...
			    <TextInput skin="png.flat.textinput" x="69" y="79" height="28" width="237" align="left" margin="5,5,," color="0xc9cdcc" size="12" font="Microsoft YaHei" selectable="false" text="请输入姓名"/>
