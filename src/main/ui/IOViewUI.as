	...
	public class IOViewUI extends Dialog {
		...
		protected var uiXML:XML =
			<Dialog>
			  ...
			  <Button label="" skin="png.flat.btn_close" x="454" y="7" var="btn_closeIOView" buttonMode="true"/>
			  ...
			  <Button label="导入" skin="png.flat.btn_enter" x="79" y="165" labelColors="0xffffff" labelSize="14" labelFont="Microsoft YaHei" var="btn_input" buttonMode="true"/>
			  <Button label="导出" skin="png.flat.btn_enter" x="325" y="165" labelColors="0xffffff" labelSize="14" labelFont="Microsoft YaHei" var="btn_output" buttonMode="true"/>
			</Dialog>;
